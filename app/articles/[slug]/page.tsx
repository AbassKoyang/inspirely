...
import { api, followUser, unfollowUser } from '@/lib/api';
...
const ArticlePage = () => {
    ...
    const unfollowMutation = useMutation({
      ...
      const likeMutation = useMutation({
        mutationFn: () =>
          api.post(`/api/posts/${String(post?.id)}/reactions/`, {reaction_type: 'upvote'}, {withCredentials: true}),
      ...
      const bookmarkMutation = useMutation({
        mutationFn: () =>
          api.post(`/api/posts/${String(post?.id)}/bookmark/`, null, {withCredentials: true}),
