...
const ArticlePage = () => {
    ...
    const followMutation = useMutation({
        mutationFn: () =>
          api.post(`/api/users/${String(post?.author.id)}/follow/`),
    ...
    const unfollowMutation = useMutation({
        mutationFn: () =>
          api.delete(`/api/users/${String(post?.author.id)}/follow/`),
        ...
        <div className="w-full">
            ...
            <div className="w-full flex lg:flex-row flex-col-reverse lg:items-center lg:gap-5 gap-3 my-5 lg:my-8">
                <div className="flex items-center gap-5">
                    ...
                    <p className='text-sm font-sans text-black'>{post?.author.first_name} {post?.author.last_name}</p>
            ...
            <div className="w-full flex items-center justify-between py-3 lg:py-2 lg:border-y border-gray-100">
                ...
                <div className="flex items-center gap-8 lg:gap-5">
                    <button disabled={isSelf} className='py-2 px-4 group cursor-pointer disabled:cursor-not-allowed border lg:border-0 border-gray-100 rounded-4xl flex items-center gap-2'>
