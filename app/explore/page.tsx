  ...
  return (
    <div className='w-full bg-white'>
      <div className="w-full flex items-center justify-center flex-col mt-5 lg:mt-10">
        ...
        <form onSubmit={handleFormSubmit} className="mt-4 lg:mt-6 focus-within:border focus-within:border-emerald-700 flex w-full lg:w-2xl h-[45px] lg:h-[65px] rounded-[60px] lg:rounded-[65px] bg-gray-100/90 items-center justify-between overflow-hidden pl-3 lg:pl-5">
