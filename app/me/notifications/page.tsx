          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              {notification.target_object && (
                <div className="mt-2">
                  {notification.action_type === 'comment' || notification.action_type === 'reply' ? (
                  ...
                  ) : notification.action_type === 'reaction' || notification.action_type === 'bookmark' ? (
                    <Link href={`/articles/${notification.target_object.slug}`} className='font-sans text-xs text-emerald-700 hover:underline' onClick={(e) => e.stopPropagation()}>
...
const NotificationsPage = () => {
  ...
  return (
    <div className='w-full relative pt-6'>
      ...
      {isError && (
        <div className="w-full flex items-center justify-center py-10">
          <p className='font-sans text-base text-red-600'>An error occurred while loading notifications.</p>
        </div>
      )}
      ...
      {allNotifications && allNotifications.length === 0 && !isLoading && (
        <div className="w-full flex items-center justify-center h-[60vh]">
          <p className='font-sans text-base text-black/60'>No notifications yet.</p>
        </div>
      )}
