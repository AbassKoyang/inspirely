    ...
    <div className='w-full md:w-[70%] flex md:flex-row flex-col md:justify-between py-4 bg-white mb-5'>
        ...
        <div className="w-full flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
                <Link href='#'>
                    <div className='rounded-full overflow-hidden object-center object-cover cursor-pointer'>
                        <Image
                        className='size-full'
        ...
        <h4 className='text-lg md:text-2xl font-semibold md:font-bold font-sans text-black mt-1 md:mt-5'>{post.title}</h4>
        <h4 className='text-base font-normal font-sans text-black/60 mt-1'>{post.content}</h4>
        ...
        <div className="w-[150px] h-[100px] rounded-xl object-cover object-center overflow-hidden mt-2 hidden md:block">
            <Image
            className='size-full'
            src={post.thumbnail || thumbnailPlaceholder}
            width={50}
