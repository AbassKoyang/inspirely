      ...
      <div className="mx-auto flex max-w-full items-center justify-between px-4 py-2 md:px-6">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            {user ? (
               <Link href="/feed" className="text-2xl font-semibold lg:text-3xl lg:font-bold text-emerald-700 transition-colors hover:text-emerald-700">
               Inspirely
              </Link>
            ) : (
        ...
        {user ? (
            <div className='flex items-center gap-4 md:gap-8 py-2'>
              ...
              {pathname == '/me/notifications' ? (
                ...
                <Bell strokeWidth={1} className='size-5.5 text-black/70 hover:text-black transition-all duration-200 ease-in-out hidden lg:block' />
              )}
              </Link>
              <Link href='/explore' className='lg:hidden'>
                <Search strokeWidth={1} className='size-6 text-black/70 hover:text-black transition-all duration-200 ease-in-out' />
              </Link>
